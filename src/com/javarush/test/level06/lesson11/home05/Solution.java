...
public class Solution
{
    ...
    {
        printIdea(new Idea()); //созданный  объект в методе main
    }

    public static void printIdea(Idea idea){
        System.out.println(idea.getDescription()); //используй аргумент idea, которая является ссылкой на созданный уже объект в методе main
    }
