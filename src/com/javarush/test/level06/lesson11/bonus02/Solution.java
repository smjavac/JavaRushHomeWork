...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        Cat catMather = new Cat(matherName, null, catGrandMather);

        String soenName = reader.readLine();
        Cat catSone = new Cat(soenName, catFather,catMather );

        String daughterName = reader.readLine();
        Cat catDaughter = new Cat(daughterName,catFather, catMather);
